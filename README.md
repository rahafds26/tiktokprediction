...
| `TikTokPredictiveModeling.ipynb` | Complete project workflow |
| `app (1).py` | Streamlit application |
| `requirements.txt` | Python dependencies |
| `submission.csv` | Kaggle submission predictions |
| `test_features.csv` | Prepared test features for prediction |
| `tiktok_predictions.csv` | Predictions generated by the Streamlit application |
